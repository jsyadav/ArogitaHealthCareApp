package com.example.arogitahealthcareapp;
...
public class BluetoothConnService extends Service {
	...
	protected static final UUID serverUUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
	...
	class ConnectThread extends Thread{
		...
		private final String address = "7C:D1:C3:7D:CA:95";
		// Well known SPP UUID
	    ...
	    //     UUID for SPP.
	    try {
	    	connectionSocket = device.createRfcommSocketToServiceRecord(MY_UUID);
	    ...
	    String message = "Hello from Android. "+ System.currentTimeMillis()+"\n";
